...
--datediff meses: month suma los a�os de diferencia con x12 para pasarlos a meses--
...
--2--
select count ([Fecha Ingreso])IngresosFecha, year([Fecha Ingreso])A�o, month([Fecha Ingreso])Mes, day([Fecha Ingreso])Dia from Estudiantes
